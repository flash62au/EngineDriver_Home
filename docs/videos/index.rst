...
* Connecting to a server |todo|
* Connection Preferences |todo|
* Preferences
	* Appearance
		* Orientation  |todo|
...
* Gamepads
	...
	* Voice Response |todo|
* Turnouts/Points and Routes |todo|
* Default Functions
	* `Default Functions <https://youtu.be/jL9odSFwZLQ>`_ 
* Import/Export/Reset Preferences
	* Server Specific Preferences |todo|
* Preserving the battery in your device |todo|
