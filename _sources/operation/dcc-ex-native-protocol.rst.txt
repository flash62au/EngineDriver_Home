...
e.g. if you enter `DC` and address `10` for track 'A", then in the |ED| Select Loco screen, you would need to enter the 'DCC Address' of `10` to control the DC loco on the track would would normally have been the 'Main' track if you were using DCC.
